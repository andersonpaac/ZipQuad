...
def getdata():
    ...
    wp_bearing = raw_input("Would you like a panorama in this location?(y/n)")
    if wp_bearing == 'yes' or wp_bearing == 'y':
        wp_bearing = consts.REQ_PANORAMA
    else:
        wp_bearing = 0.0
    wp_dur = raw_input("How long would you like your flight in seconds?\n")
    try:
        wp_dur = int(wp_dur)
    ...
    return consts.NO_HOME, [wp_lat, wp_lon, wp_alt, wp_dur, wp_bearing]
